...
class DateUtil {
  ...
  static DateTime getLastDayOfMonth(DateTime dateTime) {
    ...
    DateTime lastDay = beginningNextMonth.subtract(const Duration(days: 1));
    var timeEndOfDay = DateTime(
        lastDay.year, lastDay.month, lastDay.day, 23, 59, 59, 999, 999);
    return timeEndOfDay;
  }

  static String parseFromDateTime(DateTime? dateTime, String format) {
    return Jiffy.parseFromDateTime(dateTime ?? DateTime.now())
