...
class DioHelper {
      ...
      QueuedInterceptorsWrapper(
        ...
        onError: (error, handler) async {
          ...
          if (responseStatus != null &&
            ...
            LogUtil.d('The token has expired, need to receive new token');
  ...
  static void setInterceptorRetry(
    ...
    DefaultRetryEvaluator? retryEvaluator,
  }) {
    dio.interceptors.add(RetryInterceptor(
      ...
      retryEvaluator: retryEvaluator?.evaluate ??
          DefaultRetryEvaluator(const {
  ...
  static MediaType getMediaType(String path) {
    ...
    if (mimeType != null) {
      ...
      contentType = MediaType("application", path.split('.').last);
    }
    return contentType;
  }
