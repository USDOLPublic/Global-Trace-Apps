...
part of 'transport_partner.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class TransportPartnerAdapter extends TypeAdapter<TransportPartner> {
  @override
  final int typeId = 9;

  @override
  TransportPartner read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, TransportPartner obj) {
    writer
      ..writeByte(16)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is TransportPartnerAdapter &&
