...
part of 'purchase_partner.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class PurchasePartnerAdapter extends TypeAdapter<PurchasePartner> {
  @override
  final int typeId = 4;

  @override
  PurchasePartner read(BinaryReader reader) {
    ...
    return PurchasePartner(
      ...
      farmGroupId: fields[16] as String?,
      farmId: fields[17] as String?,
    );
  }

  @override
  void write(BinaryWriter writer, PurchasePartner obj) {
    writer
      ..writeByte(18)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is PurchasePartnerAdapter &&
